...
import { faArrowRight, faArrowLeft, faArrowsRotate, faPlay, faPause } from '@fortawesome/free-solid-svg-icons'
...
class ClockSessionBreak extends Component {
  constructor(props) {
    super(props);
    this.state = {
      brkLength: 5,
...
export default ClockSessionBreak;
